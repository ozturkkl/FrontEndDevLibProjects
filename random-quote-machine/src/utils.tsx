...
export function changeAppColor() {
  const randomColor = (Math.floor(Math.random() * 360) + 1).toString()
  cssAnimate(400)
  document.documentElement.style.setProperty("--main-color-h", `${randomColor}`)
}
